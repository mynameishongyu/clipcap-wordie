...
drop policy if exists generation_pdfs_bucket_select_authenticated
on storage.buckets;
...
drop policy if exists generation_pdfs_object_select_own_or_admin
on storage.objects;
...
drop policy if exists generation_pdfs_object_insert_own_or_admin
on storage.objects;
...
drop policy if exists generation_pdfs_object_update_own_or_admin
on storage.objects;
...
drop policy if exists generation_pdfs_object_delete_own_or_admin
on storage.objects;
